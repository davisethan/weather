...
class ObjectsSection extends React.Component {
  ...
  coordinateFormSubmit(event) {
    ...
    const HISTORICAL_WEATHER_URL = `https://api.openweathermap.org/data/2.5/onecall?lat=${this.state.latitude}&lon=${this.state.longitude}&exclude=current,minutely,hourly,alert&units=imperial&appid=${process.env.REACT_APP_WEATHER_API_KEY}`;
  ...
  render() {
    ...
    return (
      <div className="objects-section">
        ...
        <ObjectsSectionForm latitudeInputChange={this.latitudeInputChange} longitudeInputChange={this.longitudeInputChange} coordinateFormSubmit={this.coordinateFormSubmit}/>
